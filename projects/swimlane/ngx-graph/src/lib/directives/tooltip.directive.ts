...
import { ShowType, StyleType } from '../enums/tooltip.enum';
import { PlacementPosition } from '../enums/placement.enum';
import { AlignmentDirection } from '../enums/alignment.enum';
...
export class TooltipDirective implements OnDestroy {
  ...
  @Input() tooltipPlacement: PlacementPosition = PlacementPosition.top;
  @Input() tooltipAlignment: AlignmentDirection = AlignmentDirection.center;
  @Input() tooltipType: StyleType = StyleType.popover;
  ...
  @Input() tooltipShowEvent: ShowType = ShowType.all;
  ...
  private get listensForFocus(): boolean {
    return this.tooltipShowEvent === ShowType.all ||
           this.tooltipShowEvent === ShowType.focus;
  }

  private get listensForHover(): boolean {
    return this.tooltipShowEvent === ShowType.all ||
           this.tooltipShowEvent === ShowType.mouseover;
  }
