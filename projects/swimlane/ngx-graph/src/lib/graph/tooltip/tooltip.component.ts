...
import { StyleType } from '../../enums/tooltip.enum';
...
export class TooltipContentComponent implements AfterViewInit {
  ...
  @Input() type: StyleType;
  @Input() placement: PlacementPosition;
  @Input() alignment: AlignmentDirection;
  ...
  get cssClasses(): string {
    let clz = 'ngx-graph-tooltip-content';
