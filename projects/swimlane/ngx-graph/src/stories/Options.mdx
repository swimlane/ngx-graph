...
| draggingEnabled           | boolean                                  | true                                                                                    | enable dragging nodes; while dragging, the active layout’s `updateEdge` refreshes edge polylines (Dagre, DagreCluster, DagreNodesOnly, and `ElkLayout` use shared orientation-aware ports and multi-point paths so edges stay curved and aligned with node boxes)                                                                                    |
